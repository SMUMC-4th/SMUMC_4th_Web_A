...
export default function Header() {
    ...
    return (
        <HeaderDiv>
            ...
            <SearchDiv>
                <SearchButton>어디든지</SearchButton>
                <Separator>|</Separator>
                <SearchButton>언제든 일주일</SearchButton>
                <Separator>|</Separator>
                <SearchButton>게스트 추가</SearchButton>
                <SearchButtons>
                    <span style={{fontSize: '14px', paddingBottom: '3px'}}>어디든지</span>
                    <span style={{fontSize: '12px', color: '#717171'}}>언제든 일주일 ・ 게스트 추가</span>
                </SearchButtons>
                <SearchIconBtn>
            ...
            <RegisterDiv>당신의 공간을 에어비앤비하세요</RegisterDiv>
            <Language>
            ...
            <My onClick={handleMyButtonClick}>
                <svg id="my-menu" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: 3, overflow: 'visible'}}><g fill="#222222" fill-rule="nonzero"><path d="m2 16h28"></path><path d="m2 24h28"></path><path d="m2 8h28"></path></g></svg>
                <svg id="my-logo" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{display: 'block', height: '30px', width: '30px', fill: '#717171'}}><path d="m16 .7c-8.437 0-15.3 6.863-15.3 15.3s6.863 15.3 15.3 15.3 15.3-6.863 15.3-15.3-6.863-15.3-15.3-15.3zm0 28c-4.021 0-7.605-1.884-9.933-4.81a12.425 12.425 0 0 1 6.451-4.4 6.507 6.507 0 0 1 -3.018-5.49c0-3.584 2.916-6.5 6.5-6.5s6.5 2.916 6.5 6.5a6.513 6.513 0 0 1 -3.019 5.491 12.42 12.42 0 0 1 6.452 4.4c-2.328 2.925-5.912 4.809-9.933 4.809z"></path></svg>
            </My>
            <MyMenu className={isActive ? 'active' : ''}>
                <MenuItem 
                    id="my-sign-up" 
                ...
                <MenuItem id="my-register">당신의 공간을 에어비앤비하세요</MenuItem>
                <MenuItem id="my-hosting">체험 호스팅하기</MenuItem>
                <MenuItem id="my-help">도움말</MenuItem>
            </MyMenu>
            {isSignUpActive ? <SignUp/> : null}
